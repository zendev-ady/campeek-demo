...
import { Save, UserCheck, Wallet, Clock, Calendar, AlertTriangle } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Emailová oznámení při registracích</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Oznámení o platbách a splatnostech</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4">
            <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Upozornění o čekací listině a volných místech</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4">
            <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Připomínky před konáním akce</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4 space-y-2">
            <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Oznámení o změnách a zrušení akce</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4">
            <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Upozornění na nové registrace a potvrzení</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4">
            <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Oznámení o zaznamenaných platbách</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4">
            <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Upozornění na zaplnění kapacity akce</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4 space-y-2">
            <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Připomínky pro přípravu akce</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="border-2 border-black p-4 space-y-2">
            <div className="flex items-center justify-between">
